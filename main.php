    ...
    <div class="flex-container">
        ...
        <div class="about_me">
         <h1><?php echo $p; ?></h1>
            ...
            <div class="data">
                ...
                <div class="fullname">
                    ...
                    <?php echo $name, ' ', $surname . '<br>'; 
                          echo 'город:', ' ', $city; ?>  <br>                                    
                    <sub>Я обучаюсь на образовательной платформе №1
            ...
            <div class="article">
                <p class="text">
                    Здесь могла бы быть ваша реклама, но т.к. этот сайт локальный - это никому не нужно, поэтому пусть тут будет котик =)
                    <img src="img/cat.jpg" alt="мяу" title="мяу" width="400" height="300">
                </p>
            </div>
